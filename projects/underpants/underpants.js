...
_.partition = (arr, func) => [_.filter(arr, func), _.reject(arr, func)];
...
// _.every = funciton(coll, func) {
//     let arr = [];
//     _.each(coll, function(ele, ind, coll) {
//         if (!func) {
//          if (e) {
//              arr.push(true)
//          } else { 
